...
<head>
   ...
   <!-- bootstrap css -->
   <link rel="stylesheet" href="<?= Url::base(); ?>/assets/css/bootstrap.min.css">
   <!-- style css -->
   <link rel="stylesheet" href="<?= Url::base(); ?>/assets/css/style.css">
   <!-- Responsive-->
   <link rel="stylesheet" href="<?= Url::base(); ?>/assets/css/responsive.css">
   <!-- fevicon -->
   <link rel="icon" href="images/fevicon.png" type="image/gif" />
   <!-- Scrollbar Custom CSS -->
   <link rel="stylesheet" href="<?= Url::base(); ?>/assets/css/jquery.mCustomScrollbar.min.css">
   <!-- Tweaks for older IEs-->
   <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
   <!-- owl stylesheets -->
   <link rel="stylesheet" href="<?= Url::base(); ?>/assets/css/owl.carousel.min.css">
   <link rel="stylesheet" href="<?= Url::base(); ?>/assets/css/owl.theme.default.min.css">
...
<body class="main-layout">
   <!-- loader  -->
   <!-- <div class="loader_bg">
         <div class="loader"><img src="<?= Url::base(); ?>/assets/images/loading.gif" alt="#" /></div>
      </div> -->
   <!-- end loader -->
   <!-- header -->
               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"> <a href="index.html"><img src="<?= Url::base(); ?>/assets/images/logo.png" alt="#"></a> </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li class="last"><a href="#"><img src="<?= Url::base(); ?>/assets/images/search_icon.png" alt="icon" /></a></li>
                           </ul>
                        </nav>
                     </div>
                  </div>
            ...
            <div class="carousel-item active">
               <div class="container">
                  <div class="row marginii">
                     ...
                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="img-box">
                           <figure><img src="<?= Url::base(); ?>/assets/images/boksing-gloves.png" alt="img" /></figure>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="clothes_main section bg-white">
      <div class="container">
            ...
            <div class="carousel-item active">
               <div class="container">
                  <div class="row marginii">
                     ...
                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="img-box">
                           <figure><img src="<?= Url::base(); ?>/assets/images/child-image.png" style="max-width: 100%; border: 15px solid #fff;" /></figure>
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div id="testimonial" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="titlepage">
                           <div class="john">
                              <div class="john_image"><img src="<?= Url::base(); ?>/assets/images/john-image.png" style="max-width: 100%;"></div>
                              ...
                              <div class="icon_image"><img src="<?= Url::base(); ?>/assets/images/icon-1.png"></div>
                           </div>
                        </div>
                     </div>
                     <div class="carousel-item">
         ...
         <div class="address_2">
            <div class="row">
               <div class="col-sm-12 col-md-12 col-lg-4">
                  <div class="site_info">
                     <span class="info_icon"><img src="<?= Url::base(); ?>/assets/images/map-icon.png" /></span>
                     <span style="margin-top: 10px;">No.123 Chalingt Gates, Supper market New York</span>
                  </div>
               </div>
               <div class="col-sm-12 col-md-12 col-lg-4">
                  <div class="site_info">
                     <span class="info_icon"><img src="<?= Url::base(); ?>/assets/images/phone-icon.png" /></span>
                     <span style="margin-top: 21px;">( +71 7986543234 )</span>
                  </div>
               </div>
               <div class="col-sm-12 col-md-12 col-lg-4">
                  <div class="site_info">
                     <span class="info_icon"><img src="<?= Url::base(); ?>/assets/images/email-icon.png" /></span>
   ...
   <!-- Javascript files-->
   <script src="<?= Url::base(); ?>/assets/js/jquery.min.js"></script>
   <script src="<?= Url::base(); ?>/assets/js/popper.min.js"></script>
   <script src="<?= Url::base(); ?>/assets/js/bootstrap.bundle.min.js"></script>
   <script src="<?= Url::base(); ?>/assets/js/jquery-3.0.0.min.js"></script>
   <script src="<?= Url::base(); ?>/assets/js/plugin.js"></script>
   <!-- sidebar -->
   <script src="<?= Url::base(); ?>/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
   <script src="<?= Url::base(); ?>/assets/js/custom.js"></script>
   <!-- javascript -->
   <script src="<?= Url::base(); ?>/assets/js/owl.carousel.js"></script>
